...
describe('Norway Providers Test', () => {
  ...
  nextoSelectors.norway_excluded_providers.forEach(({ name, expectedName }) => {
    const urlName = expectedName || name.toUpperCase().replace(/ /g, '_');
