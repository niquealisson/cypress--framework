describe('Games, 1X2', () => {
  ...
  it('It should test the game number 1', () => {
    ...
    // Click the submit button usning the specific class
    ...
    // Navigate to 1X2 provider games
    ...
    cy.get('button[class="_providersFilterBrand_1xjny_11"]').contains('1X2').click();
