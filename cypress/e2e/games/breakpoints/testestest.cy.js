describe('Login and Deposit Test', () => {
    ...
    it('should login, close deposit popup, navigate to deposit page, scroll down, and select the Visa deposit method', () => {
      // Enter valid email
      ...
      // Access the iframe's content and click on the Visa deposit method
      cy.get('iframe.w-full.h-full')
        ...
        .then((iframe) => {
          ...
          cy.wrap(iframeBody)
            .find('a[href="/financials/deposit/ft9xIZC1QbG3MSkS195Ko3mLJ3dKUu2Y61C5YehW0x62ZaQBQBfi4G6PVttks4hQ0Je67CtW6d_wYOchdaXAWQ"]')
            .should('be.visible')
            .click();
        });
      ...
      cy.url().should(
        'include',
        '/financials/deposit/ft9xIZC1QbG3MSkS195Ko3mLJ3dKUu2Y61C5YehW0x62ZaQBQBfi4G6PVttks4hQ0Je67CtW6d_wYOchdaXAWQ'
      );
    });
  });
